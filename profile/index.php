        ...
        <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 cover">
                <div class="media align-items-end profile-head" >
                    <div class="profile mr-3" ><img src=<?php echo $fetch['image']; ?>  alt="..." width="130" class="rounded mb-2 img-thumbnail"><br><br><a href="edit.php" class="btn btn-outline-dark btn-sm btn-block">Edit profile</a></div>
<div class="col-1"><form action="check2.php" method="post"><button name="exit" type="submit" class="btn btn-outline-dark btn-sm btn-block">exit</button></form></div>
